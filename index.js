...
let botname = process.env.BOTNAME || 'JUICE WRLD';
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Congrats, JUICE WRLD has successfully connected to this server", "green"));
      console.log(color("Follow me on Instagram as @nairobi_twerk_gallery", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `〘JUICE WRLD 𝐡𝐚𝐬 𝐬𝐭𝐚𝐫𝐭𝐞𝐝. . .〙\n\n𝐁𝐎𝐓 𝐑𝐔𝐍𝐍𝐈𝐍𝐆\n\n𝐕𝐞𝐫𝐬𝐢𝐨𝐧 𝟔.𝟎.𝟖\n\nincase of any issue contact
 https://wa.me/254742516017` });
    }
